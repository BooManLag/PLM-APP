              ...
              delegate: SliverChildListDelegate(
                <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      "We also accept applicants who are not residents of Manila.",
                      style: TextStyle(
                          fontFamily: "Lato",
                          fontWeight: FontWeight.normal,
                          fontSize: 12),
                      ...
                      builder: (context) => ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => admissionsPage2()));
                        },
                        child: Text(
                          'VIEW PLMAT RESULTS',
                          style: TextStyle(
              ...
              delegate: SliverChildListDelegate(
                <Widget>[
                      ...
                      child: RichText(
                        text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                text:
                                ' Full Name, Applicant Number, and Examination Date.',
                                style: TextStyle(
                                    decoration: TextDecoration.none,
                                    fontFamily: "Lato",
                                    fontWeight: FontWeight.bold,
                              ...
                              TextSpan(
                                text:
                                'The following information are provided to you by the PLMAT Admission Committee that can be accessed through your provided personal email.',
                                style: TextStyle(
                                    decoration: TextDecoration.none,
                                    fontFamily: "Lato",
                                    fontWeight: FontWeight.normal,
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ButtonStyle(
                          ...
                          MaterialStateProperty.all<Color>(Colors.black),
                          backgroundColor:
                          MaterialStateProperty.all<Color>(Color(0xFFFFC909)),
                          shape: MaterialStateProperty.all<
                              RoundedRectangleBorder>(
                              RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(10.0),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Juan Dela Cruz,  BS Computer Science",
                      style: TextStyle(
                          fontFamily: "Lato",
                          fontWeight: FontWeight.bold,
                          fontSize: 15,
                      ...
                      child: Padding(
                        ...
                        child: DataTable(
                          ...
                          rows: [
                            ...
                            DataRow(cells: [
                              DataCell(Text('AMORES, Ma. Pauline',
                                  textAlign: TextAlign.left,
                                  style: TextStyle(
                                      fontFamily: "Lato",
                                      fontWeight: FontWeight.normal,
